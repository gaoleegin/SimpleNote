...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *consScrollViewY;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *consDockBgY;
...
//    CGRect imageRect = self.imageView.frame; // 图像视图frame
